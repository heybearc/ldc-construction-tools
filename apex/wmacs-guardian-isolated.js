...
/**
 * APEX Guardian - Repository-Isolated Implementation
...
class APEXGuardianIsolated {
  ...
  async init() {
    try {
      ...
      console.log(`[APEX] Repository-isolated guardian for: ${this.config.project.name}`);
    } catch (error) {
  ...
  async status() {
    ...
    console.log('\n🚨 APEX GUARDIAN STATUS (Repository-Isolated)');
    console.log('===============================================');
...
if (require.main === module) {
  const guardian = new APEXGuardianIsolated();
...
module.exports = { APEXGuardianIsolated };
