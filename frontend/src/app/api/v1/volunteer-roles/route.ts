...
const AVAILABLE_ROLES = [
  ...
  { category: 'CG_STAFF', name: 'Equipment Management Contact', code: 'EMC' },
  { category: 'CG_STAFF', name: 'Equipment Management Contact Assistant', code: 'EMC-Asst' },
  { category: 'CG_STAFF', name: 'Equipment Management Contact Support', code: 'EMC-Support' },
  { category: 'CG_STAFF', name: 'Housing Contact', code: 'HC' },
  { category: 'CG_STAFF', name: 'Housing Contact Assistant', code: 'HC-Asst' },
  { category: 'CG_STAFF', name: 'Housing Contact Support', code: 'HC-Support' },
  { category: 'CG_STAFF', name: 'Personnel Contact', code: 'PC' },
  { category: 'CG_STAFF', name: 'Personnel Contact Assistant', code: 'PCA' },
  { category: 'CG_STAFF', name: 'Personnel Contact Support', code: 'PC-Support' },
  { category: 'CG_STAFF', name: 'Regulatory Contact', code: 'REG' },
  { category: 'CG_STAFF', name: 'Regulatory Contact Assistant', code: 'REG-Asst' },
  { category: 'CG_STAFF', name: 'Regulatory Contact Support', code: 'REG-Support' },
  { category: 'CG_STAFF', name: 'Safety Coordinator Contact', code: 'SCC' },
  { category: 'CG_STAFF', name: 'Safety Coordinator Contact Assistant', code: 'SCC-Asst' },
  { category: 'CG_STAFF', name: 'Safety Coordinator Contact Support', code: 'SCC-Support' },
  { category: 'CG_STAFF', name: 'Sourcing Buyer', code: 'SB' },
  { category: 'CG_STAFF', name: 'Sourcing Buyer Assistant', code: 'SB-Asst' },
  { category: 'CG_STAFF', name: 'Sourcing Buyer Support', code: 'SB-Support' },
  { category: 'CG_STAFF', name: 'Training Organizer', code: 'TO' },
  { category: 'CG_STAFF', name: 'Training Organizer Assistant', code: 'TO-Asst' },
  { category: 'CG_STAFF', name: 'Training Organizer Support', code: 'TO-Support' },
  { category: 'CG_STAFF', name: 'Translation Buyer', code: 'TB' },
  { category: 'CG_STAFF', name: 'Translation Buyer Assistant', code: 'TB-Asst' },
  { category: 'CG_STAFF', name: 'Translation Buyer Support', code: 'TB-Support' },
