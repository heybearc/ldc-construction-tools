...
const AVAILABLE_ROLES = [
  ...
  { category: 'CONSTRUCTION_STAFF', name: 'Field Rep Support', code: 'FR-Support' },
  { category: 'CONSTRUCTION_STAFF', name: 'Field Rep Assistant', code: 'FRAA' },
  { category: 'CONSTRUCTION_STAFF', name: 'Field Rep Assistant Support', code: 'FRAA-Support' },
  ...
  { category: 'CONSTRUCTION_STAFF', name: 'Field Cost Controller Support', code: 'LCC-Field-Support' },
  { category: 'CONSTRUCTION_STAFF', name: 'Personnel Contact', code: 'PC' },
  { category: 'CONSTRUCTION_STAFF', name: 'Personnel Contact Support', code: 'PC-Support' },
