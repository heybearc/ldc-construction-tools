...
interface VolunteerStats {
  ...
  assistants: number;
  support: number;
  congregations: Array<{ name: string; count: number }>;
}
...
export default function VolunteersPage() {
  ...
  const getRoleBadge = (volunteer: Volunteer) => {
    if (volunteer.is_overseer) {
      return <span className="px-2 py-1 text-xs font-medium bg-blue-100 text-blue-800 rounded-full">Overseer</span>;
    }
    if (volunteer.is_assistant) {
      return <span className="px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">Assistant</span>;
    }
    return <span className="px-2 py-1 text-xs font-medium bg-gray-100 text-gray-800 rounded-full">Support</span>;
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-gray-600">Overseers</p>
                  <p className="text-2xl font-bold text-gray-900">{stats.overseers}</p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.assistants}</p>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.support}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600">{volunteers.length} volunteers found</p>
          </div>
