...
/**
 * WMACS Guardian MCP - Production Diagnostic System
 * 
 * Systematic diagnosis and fix following WMACS rules and guardrails
 */
...
class WMACSProductionDiagnostic {
  constructor() {
    this.config = {
  ...
  async diagnoseStep1_ContainerHealth() {
    console.log('🛡️ WMACS Guardian MCP: Step 1 - Container Health Diagnosis');
  ...
  async diagnoseStep2_DatabaseConnectivity() {
    console.log('🛡️ WMACS Guardian MCP: Step 2 - Database Connectivity Diagnosis');
  ...
  async diagnoseStep3_PrismaStatus() {
    console.log('🛡️ WMACS Guardian MCP: Step 3 - Prisma Status Diagnosis');
  ...
  async diagnoseStep4_ApplicationLogs() {
    console.log('🛡️ WMACS Guardian MCP: Step 4 - Application Logs Analysis');
  ...
  async applyFix1_DatabaseSetup() {
    console.log('🛡️ WMACS Guardian MCP: Fix 1 - Database Setup');
  ...
  async applyFix2_PrismaSetup() {
    console.log('🛡️ WMACS Guardian MCP: Fix 2 - Prisma Setup');
  ...
  async applyFix3_ServiceRestart() {
    console.log('🛡️ WMACS Guardian MCP: Fix 3 - Clean Service Restart');
  ...
  async runFullDiagnosis() {
    console.log('🛡️ WMACS Guardian MCP: Starting Full Production Diagnosis');
    console.log('=====================================');
    ...
    console.log('\\n🛠️ WMACS Guardian MCP: Applying Systematic Fixes');
    console.log('=====================================');
...
if (require.main === module) {
  const diagnostic = new WMACSProductionDiagnostic();
  
  diagnostic.runFullDiagnosis().then(result => {
    console.log('\\n🎉 WMACS Guardian MCP: Diagnostic Complete');
    console.log('=====================================');
    ...
    console.log('\\n🛡️ WMACS Guardian Status:', allFixed ? '✅ Production Fixed' : '⚠️ Issues Remain');
    
    process.exit(allFixed ? 0 : 1);
  }).catch(error => {
    console.error('❌ WMACS Guardian MCP: Diagnostic failed:', error.message);
    process.exit(1);
  });
}

module.exports = WMACSProductionDiagnostic;
